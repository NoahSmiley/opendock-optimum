  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-top">
        ...
        <button className="btn-add" onClick={onNew}>+</button>
      </div>
      ...
      <div className="sidebar-notes">
        ...
        {notes.map((n) => (
          <div key={n.id} className={`note-item${n.id === activeId ? " active" : ""}`} onClick={() => onSelect(n.id)} onContextMenu={(e) => onContext(e, n.id)}>
            ...
            {preview(n.content) && <div className="note-item-preview">{preview(n.content)}</div>}
          </div>
        ))}
      </div>
