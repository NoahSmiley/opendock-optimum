...
export function ToolbarPlugin() {
  ...
  return (
    <div
      ref={toolbarRef}
      className="shrink-0 flex items-center gap-0.5 border-b border-neutral-200 bg-white/95 px-4 py-2 backdrop-blur-sm dark:border-neutral-800 dark:bg-neutral-950/95"
    >
      {/* Text formatting */}
      <button
        onClick={() => {
